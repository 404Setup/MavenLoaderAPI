...
public class LibraryResolver {
    ...
    public void addRepository(@NotNull RemoteRepository repository) {
        if (!Config.isWhitelistRepo(repository.getUrl())) {
            logger.warn("The far end repository {} is not on the white list and has refused to visit.", repository.getUrl());
            return;
        }
    ...
    public void addRepository(@NotNull String repository, @NotNull String name) {
        if (!Config.isWhitelistRepo(repository)) {
            logger.warn("The far end repository {} is not on the white list and has refused to visit.", repository);
            return;
        }
